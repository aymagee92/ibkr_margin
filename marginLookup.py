...
# --- variables ---
symbol_list = ['AAPL','SPY','NIO','WPC','BABA','GME','AMC','COIN','MSFT','QQQ','AAL']
enable_stock_price_override = True                                                                  # see note at bottom. If False, last_price_override will not work.
last_price_override = [186,433,8.44,66.57,84.88,23.60,4.04,61.26,335.02,362.54,16.23]                      # See note at bottom. FILL OUT PRICE DATA FOR ALL SYMBOLS AND IN THE SAME ORDER.
checking = ['long','short']
sort_by =  1                                                                                           # this sorts the results highest to lowest by the specified column.
# columns:
